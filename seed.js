...
const settings = {
  ...
  home_services: JSON.stringify([
    ...
    { image: '/assets/hero-kurulum-v2.webp', title: 'Dış Mekan Kamera Sistemleri', desc: 'Hava koşullarına dayanıklı, 7/24 kesintisiz kayıt yapabilen dış mekan kameraları.' },
    { image: '/assets/paket-4lu.webp', title: 'IP Kamera Çözümleri', desc: 'Uzaktan erişim ve mobil izleme desteği ile dilediğiniz yerden güvenliğinizi kontrol edin.' }
  ]),
...
console.log('  ✓ Pages (hakkimizda, kvkk)');

// ─── Navigation Items ───
const navItems = [
  { label: 'Ana Sayfa', url: '/', sort_order: 1, is_active: 1 },
  { label: 'Paketler', url: '/paketler', sort_order: 2, is_active: 1 },
  { label: 'Hakkımızda', url: '/hakkimizda', sort_order: 3, is_active: 1 },
  { label: 'Referanslar', url: '/referanslar', sort_order: 4, is_active: 1 },
  { label: 'Blog', url: '/blog', sort_order: 5, is_active: 1 },
  { label: 'İletişim', url: '/iletisim', sort_order: 6, is_active: 1 },
];
...
console.log('  ✓ Footer sections & links');
...
// ─── Projects ───
const projects = [
  { title: 'Yıldız Rezidans Güvenlik Sistemi', description: '16 adet IP kamera, NVR kayıt cihazı ve mobil izleme altyapısı ile site genelinde kapsamlı güvenlik çözümü.', image: '/assets/hero-kurulum-v2.webp', category: 'Toplu Konut', client: 'Yıldız Rezidans', sort_order: 1, is_published: 1 },
  { title: 'Cafe Plus İç Mekan Güvenlik', description: '4 adet mini dome kamera ile kafe içi ve dış alan güvenliği sağlandı. Gece görüş destekli sistem.', image: '/assets/hero-kurulum-v2.webp', category: 'İşletme', client: 'Cafe Plus', sort_order: 2, is_published: 1 },
  { title: 'Özel Eğitim Merkezi Kamera Sistemi', description: '8 kameralı sistem ile tüm sınıflar ve giriş çıkışlar 7/24 izleniyor. Veli bilgilendirme panosu entegre edildi.', image: '/assets/hero-kurulum-v2.webp', category: 'Eğitim', client: 'Özel Eğitim Merkezi', sort_order: 3, is_published: 1 },
  { title: 'Öztürk Oto Galeri Dış Mekan Çözümü', description: '6 adet gece görüşlü ultra HD kamera ile açık otopark 7/24 güvenlik altında.', image: '/assets/hero-kurulum-v2.webp', category: 'Ticari', client: 'Öztürk Oto Galeri', sort_order: 4, is_published: 1 },
];
...
// ─── Packages ───
const packages = [
  { slug: 'baslangic-paketi', name: 'Başlangıç Paketi', subtitle: '2 Kameralı Sistem', price: 7990, price_label: 'TL + KDV', features: `2 Adet Full HD Kamera\n1080p Çözünürlük\nGece Görüş (30m)\n4 Kanal Kayıt Cihazı\n500GB Harddisk\nMobil İzleme Desteği\nKablo & Ekipman Dahil\nProfesyonel Kurulum`, is_popular: 0, is_published: 1, sort_order: 1 },
  { slug: 'standart-paket', name: 'Standart Paket', subtitle: '4 Kameralı Sistem', price: 12990, price_label: 'TL + KDV', features: `4 Adet Full HD Kamera\n1080p Çözünürlük\nGece Görüş (40m)\n8 Kanal Kayıt Cihazı\n1TB Harddisk\nMobil İzleme Desteği\nSes Kaydı Desteği\nKablo & Ekipman Dahil\nProfesyonel Kurulum`, is_popular: 1, is_published: 1, sort_order: 2 },
  { slug: 'profesyonel-paket', name: 'Profesyonel Paket', subtitle: '8 Kameralı Sistem', price: 21990, price_label: 'TL + KDV', features: `8 Adet 4K Ultra HD Kamera\n4K Çözünürlük\nGece Görüş (50m)\n16 Kanal Kayıt Cihazı\n2TB Harddisk\nMobil İzleme Desteği\nSes Kaydı Desteği\nHareket Algılama\nKablo & Ekipman Dahil\nProfesyonel Kurulum`, is_popular: 0, is_published: 1, sort_order: 3 },
  { slug: 'premium-paket', name: 'Premium Paket', subtitle: '16 Kameralı Sistem', price: 34990, price_label: 'TL + KDV', features: `16 Adet 4K Ultra HD Kamera\n4K Çözünürlük\nGece Görüş (60m)\n32 Kanal Kayıt Cihazı\n4TB Harddisk\nMobil İzleme Desteği\nSes Kaydı Desteği\nHareket Algılama + Alarm\nUPS Kesintisiz Güç\nKablo & Ekipman Dahil\nProfesyonel Kurulum`, is_popular: 0, is_published: 1, sort_order: 4 },
];
...
const posts = [
  {
    ...
    image: '/assets/hero-kurulum-v2.webp',
