...
async function initDb() {
  ...
  // Migration: add category column to packages (for existing DBs)
  try {
    db.run("ALTER TABLE packages ADD COLUMN category TEXT DEFAULT 'ekonomik'");
  } catch (e) {
...
function createTables() {
  db.run(`
    ...
    CREATE TABLE IF NOT EXISTS packages (
      ...
      category TEXT DEFAULT 'ekonomik',
